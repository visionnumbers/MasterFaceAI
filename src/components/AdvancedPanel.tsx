...
export function AdvancedPanel({ settings, setSettings, isDark }: AdvancedPanelProps) {
  ...
  return (
    <div className={`w-full min-h-full ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-slate-50 border-slate-200'} border-l flex flex-col p-5 gap-6 transition-colors duration-300 overflow-y-auto custom-scrollbar h-full`}>
